...
class ManualContent {
  ...
  static const admin = <ManualSection>[
    ...
    ManualSection(
      title: '管理者の役割',
      summary: '自分自身の出勤・退勤・日報を使いながら、会社全体の現場・人員・請求・権限を管理します。',
      buttonLabel: 'メニュー',
    ...
    ManualSection(
      title: '従業員・権限管理',
      summary: '一般ユーザー、サブ管理者、管理者の役割と、利用できる管理機能を設定します。',
      buttonLabel: 'アプリ利用者の権限',
      steps: ['対象者を選ぶ', '役割を設定', '必要な管理権限だけON', '承認担当者は別枠で1〜3名設定'],
      support: 'サブ管理者には請求書・現場単価を付与しません。管理者は会社の請求・単価情報を扱えます。',
    ),
    ManualSection(
      title: '現場・現場単価の管理',
      summary: '現場名、請求先会社、住所、最寄り駅、配置と管理者用の現場単価を管理します。',
      buttonLabel: '現場 / 管理者用現場データ',
      steps: ['現場を登録', '請求先・住所・最寄り駅を確認', '必要なメンバーを配置', '現場単価を管理'],
      support: '管理者用現場データは第2認証対象です。サブ管理者には現場単価を表示しません。',
    ),
    ManualSection(
      title: '請求書・第2認証',
      ...
      support: 'アプリをバックグラウンドへ送ると再ロックします。必要書類・資格証は第2認証対象ではありません。',
    ),
    ManualSection(
      title: '会社単価・手当設定',
      summary: '税率、福利厚生費率、残業・早出・夜勤・休日出勤単価、任意手当3種類を管理します。',
      buttonLabel: '会社単価・手当設定',
      steps: ['設定を開く', '税率・福利厚生費率を確認', '勤務単価を入力', '任意手当を最大3つ設定', '保存'],
      support: '初回設定後も管理者が変更できます。請求や給与計算へ影響するため、変更後は数値を確認してください。',
    ),
    ManualSection(
      title: '勤怠・日報の管理',
      summary: '自分の勤怠とは別に、権限のある管理画面から会社全体の出勤状況と日報承認を確認します。',
      buttonLabel: '出勤・人区管理 / 承認待ち',
      steps: ['現場別の出勤状況を確認', '未打刻を確認', '日報修正申請を確認', '承認または却下'],
      support: '日報修正は固定2名承認ではなく、会社で設定した承認担当者のうち1人が承認します。',
    ),
    ManualSection(
      title: '運用準備・説明書更新',
      ...
      support: 'SKOの大幅更新時は、一般・サブ管理者・管理者の説明書とパンフレットもセットで更新します。',
    ),
  ];
